...
public class MealTestData {
    ...
    public static final int CALORIES_PER_DAY = SecurityUtil.authUserCaloriesPerDay();
    ...
    public static final List<MealTo> mealsTo = MealsUtil.getTos(meals, CALORIES_PER_DAY);
