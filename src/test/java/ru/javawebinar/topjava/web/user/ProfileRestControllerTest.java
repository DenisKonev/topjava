...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerWithInvalidEmail() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "invalid-email", "newPassword", 1500);
    ...
    void registerWithShortPassword() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "newemail@ya.ru", "pwd", 1500);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(newTo)))
                .andDo(print())
    ...
    void updateWithInvalidData() throws Exception {
        UserTo updatedTo = new UserTo(null, "newName", "invalid-email", "newPassword", 1500);
