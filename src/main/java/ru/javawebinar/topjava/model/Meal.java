...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.FIND_BY_ID, query = "SELECT m FROM Meal m WHERE m.id = :id AND m.user.id = :userId"),
        @NamedQuery(name = Meal.FIND_BY_DATE_TIME_RANGE,
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String FIND_BY_DATE_TIME_RANGE = "Meal.findByDateTimeRange";
